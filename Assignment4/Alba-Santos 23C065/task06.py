...
Original file is located at
    https://colab.research.google.com/drive/1vGPyAINXS0VuJs9DBq9vyeJfshHe5HLv
...
# Visualize the results
ns = Namespace("http://somewhere#")
g.add((ns.Researher, RDFS.subClassOf, ns.Person))
for s, p, o in g:
  print(s,p,o)
...
g.add((ns.jane, SCHEMA.email, Literal("janesmithers@gmail.com")))
...
g.add((ns.JohnSmith, SCHEMA.works, EX.UPM))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
